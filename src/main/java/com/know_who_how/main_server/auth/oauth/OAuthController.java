...
public class OAuthController {
    ...
    public void oauth2Login(
        ...
        if (error != null) {
            ...
            // TODO: 클라이언트의 실제 에러 페이지 주소로 변경해야 합니다.
            response.sendRedirect("http://localhost:3000/login?error=social_login_failed");
            return;
        }
        ...
        // 클라이언트 리다이렉트 URL 생성
        // TODO: 클라이언트의 실제 도메인으로 변경해야 합니다.
        String clientRedirectUrl = "http://localhost:3000/oauth/callback";
